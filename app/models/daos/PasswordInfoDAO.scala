...
/**
  ...
  */
class PasswordInfoDAO @Inject()(protected val dbConfigProvider: DatabaseConfigProvider) extends DelegableAuthInfoDAO[PasswordInfo] with DAOSlick {
    ...
    /**
      * Логгер.
      */
    private val logger: Logger = Logger("PasswordInfoDAO")
    ...
    def find(loginInfo: LoginInfo): Future[Option[PasswordInfo]] = {
        logger.info(s"Find password info for login info : $loginInfo \n\t\tQuery : ${passwordInfoQuery(loginInfo).result.statements.headOption}")
